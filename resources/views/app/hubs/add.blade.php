                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
                            ...
                            <div id="step-1">
                                <div class="well" style="border-radius: 0px;">
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade in" role="alert" id="step-one-valid-failed" style="display: none;">
                            ...
                            <div id="step-2">
                                <div class="well" style="border-radius: 0px;">
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade in" role="alert" id="step-two-valid-failed" style="display: none;">
                                        <strong>Woops!</strong> Please double check the below fields and try again!
                                    </div>
                                    <div class="form-horizontal form-label-left">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                {!! Form::text('hub_api_enc', null,['required' => 'true', 'placeholder' => 'Carriage Hub Encryption Key', 'class' => 'form-control col-md-7 col-xs-12']) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
